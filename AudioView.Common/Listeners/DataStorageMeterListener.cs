        ...
        private async void WriteReading(bool major, DateTime time, ReadingData data)
        {
            ...
            try
            {
                ...
                var reading = new Reading()
                {
                    ...
                    Hz6_3 = data.LAeqOctaveBand.Hz6_3,
                    Hz8 = data.LAeqOctaveBand.Hz8,
                    Hz10 = data.LAeqOctaveBand.Hz10,
                    Hz12_5 = data.LAeqOctaveBand.Hz12_5,
                    Hz16 = data.LAeqOctaveBand.Hz16,
                    Hz20 = data.LAeqOctaveBand.Hz20,
                    Hz25 = data.LAeqOctaveBand.Hz25,
                    Hz31_5 = data.LAeqOctaveBand.Hz31_5,
                    Hz40 = data.LAeqOctaveBand.Hz40,
                    Hz50 = data.LAeqOctaveBand.Hz50,
                    Hz63 = data.LAeqOctaveBand.Hz63,
                    Hz80 = data.LAeqOctaveBand.Hz80,
                    Hz100 = data.LAeqOctaveBand.Hz100,
                    Hz125 = data.LAeqOctaveBand.Hz125,
                    Hz160 = data.LAeqOctaveBand.Hz160,
                    Hz200 = data.LAeqOctaveBand.Hz200,
                    Hz250 = data.LAeqOctaveBand.Hz250,
                    Hz315 = data.LAeqOctaveBand.Hz315,
                    Hz400 = data.LAeqOctaveBand.Hz400,
                    Hz500 = data.LAeqOctaveBand.Hz500,
                    Hz630 = data.LAeqOctaveBand.Hz630,
                    Hz800 = data.LAeqOctaveBand.Hz800,
                    Hz1000 = data.LAeqOctaveBand.Hz1000,
                    Hz1250 = data.LAeqOctaveBand.Hz1250,
                    Hz1600 = data.LAeqOctaveBand.Hz1600,
                    Hz2000 = data.LAeqOctaveBand.Hz2000,
                    Hz2500 = data.LAeqOctaveBand.Hz2500,
                    Hz3150 = data.LAeqOctaveBand.Hz3150,
                    Hz4000 = data.LAeqOctaveBand.Hz4000,
                    Hz5000 = data.LAeqOctaveBand.Hz5000,
                    Hz6300 = data.LAeqOctaveBand.Hz6300,
                    Hz8000 = data.LAeqOctaveBand.Hz8000,
                    Hz10000 = data.LAeqOctaveBand.Hz10000,
                    Hz12500 = data.LAeqOctaveBand.Hz12500,
                    Hz16000 = data.LAeqOctaveBand.Hz16000,
                    Hz20000 = data.LAeqOctaveBand.Hz20000
                };
